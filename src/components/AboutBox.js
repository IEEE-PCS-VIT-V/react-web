...
export default function AboutBox(props) {
  ...
  return (
    ...
    <div className='flex h-72 mb-12 mt-12 mx-auto ' data-aos='flip-left'>
        ...
        <div className='max-w-96 bg-sky-blue rounded-3xl md:rounded-none md:rounded-r-3xl  text-center'> 
    ...
    <div className='max-w-96 bg-sky-blue rounded-3xl md:rounded-none md:rounded-l-3xl  text-center'> 
